        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <br>
                   <form action="{{ route('heroskill.store',$hero->id) }}" class="form-horizontal" method="POST">
                       ...
                       <tbody>
                           ...
                           @foreach ($hero->joinSkill as $value)
                                <tr>
                                    ...
                                    <td>{{ $value->nama }}</td>
                                    <td>
                                        <a href="{{ route('heroskill.destroy',$value->id) }}" class="btn btn-danger btn-sm">Hapus</a>
                                    </td>
                                </tr>    
                           @endforeach
                       </tbody>
